...
void syr_backwashtime_set(uint16_t value)
{
    ...
    device_config_put("rsd",Setting_Backwashtime);
}
...
void syr_tdslimit_set(uint16_t value)
{
    ...
    device_config_put("cnl",Setting_Hardness);
}
...
void syr_tdscalib_set(uint16_t value)
{
    ...
    device_config_put("cnf",value);
}
void syr_range_set(uint32_t value)
{
    Time_Range = value;
    Flash_Set(22,Time_Range);
    device_config_put("rsi",Time_Range);
...
void syr_language_set(uint8_t value)
{
    ...
    device_config_put("lng",Setting_Language);
...
void syr_telemetry_interval_set(uint32_t value)
{
    Telemetry_Interval = value;
    LOG_D("syr_telemetry_period_set %d\r\n",value);
    wti_timer_set(value);
    Flash_Set(24,value);
    device_config_put("wti",value);
}
uint32_t syr_telemetry_interval_get(void)
{
    LOG_D("syr_telemetry_period_get %d\r\n",Telemetry_Interval);
    return Telemetry_Interval;
}
extern uint32_t AP_Timeout;
void syr_ap_timeout_set(uint32_t value)
{
    ap_timeout_set(value);
    LOG_D("syr_ap_timeout_set %d\r\n",value);
    Flash_Set(26,value);
    device_config_put("apt",value);
}
uint32_t syr_ap_timeout_get(void)
{
    LOG_D("syr_telemetry_interval_get %d\r\n",AP_Timeout);
    return AP_Timeout;
}
extern uint32_t Report_Interval;
void syr_report_interval_set(uint32_t value)
{
    Report_Interval = value;
    LOG_D("syr_report_interval_set %d\r\n",value);
    rcp_timer_set(value);
    Flash_Set(25,value);
    device_config_put("rcp",value);
}
uint32_t syr_report_interval_get(void)
{
    LOG_D("syr_report_interval_get %d\r\n",Report_Interval);
...
void syr_wifi_ap_enable_set(uint8_t value)
{
    ...
    device_config_put("wad",value);
}
uint8_t syr_wifi_ap_enable_get(void)
{
